...
export default function Consultation() {
  ...
  return (
    <div className="min-h-screen bg-white">
      {/* Hero Section */}
      <section className="py-20 bg-gradient-to-br from-red-100 via-orange-50 to-yellow-50">
      ...
      <section className="py-20 bg-gradient-to-r from-purple-50 via-blue-50 to-green-50">
        <div className="max-w-4xl mx-auto px-4 text-center">
          <motion.div
            ...
            transition={{ duration: 0.8 }}
          >
            <h2 className="text-3xl font-bold text-gray-900 mb-8">Why Choose Our Free Consultation?</h2>
